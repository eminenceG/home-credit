...
def prepare_data()
  ...
  one_hot_encoding_using_feature_map(data, get_one_hot_feature_map_from_the_origin_dataset(data))
...
def train_one_classifier(dataset)
  ...
  sgd, iter, losses = train(sgd, model, w, dataset, num_epoch = 5, batch_size = 20)
